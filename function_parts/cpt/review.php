...
--------------------------------------------------*/
    ...
    function NC_custom_review() {
        register_post_type('review',
            array(
                'labels'                =>          array(
                    'name'              =>          'Review', //nome principale nella sidebar
                    ...
                    <div class="row">
                            ...
                            ?>
                                <div class="col-12 col-lg-6 mb-64">
                                    <article>
                                        ...
                                        <div class="review-text mb-32"><?php the_content(); ?></div> 
                        ...
                        <div class="col-12 col-lg-6 review-cta-col mb-64">
                            <div class="review-cta">
                                <p class="mb-24">Would you be the next?</p>
