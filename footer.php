    ...
    <footer class="pb-m pt-m">
        <div class="container-fluid">
            ...
            <div class="row align-items-center mb-l">
                <div class="col-12 col-lg-8 t-center-mobile mb-s">
                ...
                <div class="col-12 col-lg-4">
                    <div class="row align-items-center">
                        <div class="col-6 t-center">
                            <!--Facebook-->
                            <a href="<?php echo get_theme_mod("NC_social_facebook"); ?>" target="_blank">
                        ...
                        <div class="col-6 t-center">
                            <!--Instagram-->
                            <a href="<?php echo get_theme_mod("NC_social_instagram"); ?>" target="_blank">
                                <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="22" cy="22" r="22" class="svg-social-icon-bg"/>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 mb-s">

                    <!--logo dinamico-->
                    <div class="logo mb-s">
                        <?php if(get_theme_mod("NC_logo_footer")) { ?>
                            <a class="navbar-brand" href="<?php echo esc_url_raw(home_url()); ?>">
                                <img src="<?php echo get_theme_mod("NC_logo_footer"); ?>" alt="<?php echo get_theme_mod("NC_logo_alt_text"); ?>">
                            </a>
                        <?php } else { ?>
                    ...
                    <!--legal info-->
                    <p><?php echo get_theme_mod("NC_contatti_telefono"); ?></p>
                    <p><?php echo get_theme_mod("NC_contatti_email"); ?></p>
                    <p><?php echo get_theme_mod("NC_contatti_indirizzo"); ?></p>
                    <p><?php echo get_theme_mod("NC_contatti_piva"); ?></p>
                </div>
                ...
                <div class="col-12">
                    <p>
                        ...
                        <a href="<?php echo get_privacy_policy_url() ?>" class="link-ghost">Privacy e Cookies</a> •
                        <a href="" class="link-ghost">Credits</a>
                    </p>
                </div>
            </div>
