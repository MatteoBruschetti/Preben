            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-9">
                    <div class="row">
                        ...
                        <div class="col-auto col-legal-info">
                            ...
                            <p>Phone: <a href="tel:<?php echo get_theme_mod("NC_contatti_telefono"); ?>" target="_blank"><?php echo get_theme_mod("NC_contatti_telefono"); ?></a></p>
                            <p>Email: <a href="mailto:<?php echo get_theme_mod("NC_contatti_email"); ?>" target="_blank"><?php echo get_theme_mod("NC_contatti_email"); ?></a></p>
                ...
                <div class="col-9 offset-md-3 col-lg-3 offset-lg-0 col-social-privacy">
                    <div class="row">
                        <div class="col-4">
                            <!--Facebook-->
                            <a class="social-icon-link" href="<?php echo get_theme_mod("NC_social_facebook"); ?>" target="_blank">
                        ...
                        <div class="col-4">
                            <!--Instagram-->
                            <a class="social-icon-link" href="<?php echo get_theme_mod("NC_social_instagram"); ?>" target="_blank">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="28" cy="28" r="22.75" fill="white"/>
                        ...
                        <div class="col-4">
                            <!--Youtube-->
                            <a class="social-icon-link" href="<?php echo get_theme_mod("NC_social_youtube"); ?>" target="_blank">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="28" cy="28" r="22.75" fill="white"/>
